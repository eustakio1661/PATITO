...
<body>
						...
						<div class="card radius-15 mb-3 box-shadow">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="col-md-9">
										<form class="float-md-end" action="rese" method="post"
											novalidate>
											<div class="row row-cols-md-auto g-lg-3">
												<label for="inputFromDate"
													class="col-md-2 col-form-label text-md-end">F.Inicial</label>
												<div class="col-md-4">
													<input type="date" class="form-control"
														name="txtFechaInicio" value="reporte">
												</div>
												<label for="inputToDate"
													class="col-md-2 col-form-label text-md-end">F.Final</label>
												<div class="col-md-4">
													<input type="date" class="form-control"
														name="txtFechaFinal" value="reporte">
												</div>
												<div class="col-md-12 col-form-label text-md-end">
													<button class="btn btn-primary" name="opcion"
														value="reporte">Filtrar Búsqueda</button>
												</div>
											</div>
										</form>
									</div>
											...
											<c:forEach items="${ listadoVentas }" var="ven">
												<tr>
													...
													<td><fmt:setLocale value="es_PE" /> <fmt:formatNumber
															type="currency" value="${ven.precio}" /></td>
													<td><fmt:setLocale value="es_PE" /> <fmt:formatNumber
															type="currency" value="${ven.descuento}" /></td>
													<td><fmt:setLocale value="es_PE" /> <fmt:formatNumber
															type="currency" value="${ven.importeTotal}" /></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
	...
	<script
		src="https://cdn.datatables.net/buttons/1.7.1/js/buttons.bootstrap5.min.js"></script>
