															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="ms-2">
																			<h6 class="mb-1 font-14">${carro.nombreProd }</h6>
																		</div>
																	</div>
																</td>
																<td>${carro.precio }</td>
									...
									<div class="border border-3 p-4 rounded">
										<form action="venser" method="post">
											...
											<div class="row g-3">
												<div class="col-md-10">
													<h4>Cliente</h4>
													<label class="mb-3">Nombre:
														${ClienteCompra.nombreCompleto }</label> <br> <label
														class="mb-3">Distrito:
														${ClienteCompra.nombreDistrito }</label> <br> <label>Direccion:
														${ClienteCompra.direccion }</label>
												...
												<div class="col-sm-4">
													...
													<c:if
														test="${ClienteDescuento.descuento != 0}">
												...
												<div class="col-12">
													<div class="d-grid">
														<button type="submit" class="btn btn-primary" name="opcion" value="procCompra"
