...
ID INT, DNI CHAR(8), NOM VARCHAR(50), APE VARCHAR(50), TELEF VARCHAR(10),TIPO INT, ESTADO TINYINT, IMG VARCHAR(1000)
)
BEGIN
UPDATE EMPLEADO SET 
DNI = DNI,
...
DROP PROCEDURE IF EXISTS USP_ACTUALIZARPERFIL;
DELIMITER $$
CREATE PROCEDURE USP_ACTUALIZAREMPLEADO(
