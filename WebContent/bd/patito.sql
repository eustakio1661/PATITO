...
BEGIN
SELECT E.ID_EM,E.DNI,E.NOMBRE,E.APELLIDO,E.TELEFONO,E.DIRECCION,E.CORREO,E.USUARIO,E.CLAVE,TE.ID_TP,E.ESTADO,E.IMAGEN FROM EMPLEADO AS E
...
DELIMITER $$
CREATE PROCEDURE USP_REGISTRARPRODUCTO(DESCP VARCHAR(100), PRE DECIMAL(6,2), CANT TINYINT, CATEGORIA INT,IMG VARCHAR(1000)
)
BEGIN
...
DELIMITER $$
CREATE PROCEDURE USP_ACTUALIZARPRODUCTO(IDPROD INT, DESCR VARCHAR(100), PRE DECIMAL(6,2), CANT TINYINT, IDCAT INT, IMG VARCHAR(1000))
BEGIN
UPDATE PRODUCTO SET DESCRIPCION = DESCR, PRECIO = PRE, CANTIDAD = CANT, ID_CA = IDCAT, IMAGEN = IMG WHERE ID_PRO = IDPROD;
END$$
DELIMITER ;
...
BEGIN
SELECT P.ID_PRO,P.DESCRIPCION,P.PRECIO,P.CANTIDAD,C.DESCRIPCION,P.IMAGEN,P.ESTADO FROM PRODUCTO AS P
