...
CREATE TABLE EMPLEADO(
  ...
  TELEF_USU  VARCHAR(10)  NOT NULL UNIQUE,
...
BEGIN
SELECT E.ID_EM,E.DNI_USU,E.NOM_USU,E.APE_USU,E.TELEF_USU,E.CORREO_USU,E.USU_USU,E.CLAVE_USU,TE.ID_TP,E.ESTADO,E.IMAGEN FROM EMPLEADO AS E
...
DELIMITER $$
CREATE PROCEDURE USP_VALIDARACCESO (CORREO VARCHAR(100) ,USR VARCHAR(50), PAS VARCHAR(50))
BEGIN
SELECT * FROM EMPLEADO WHERE (CORREO_USU = CORREO OR USU_USU = USR) AND CLAVE_USU = PAS AND ESTADO = 1;
END$$
DELIMITER ;
...
CALL USP_VALIDARACCESO('JhonDoe@gmail.com','99999','99999');
