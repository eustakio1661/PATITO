...
/*FUNCI�N AUTOGENERADO DEL CORREO-->EMPLEADO*/
...
/*FUNCI�N AUTOGENERADO DEL USUARIO-->EMPLEADO*/
...
/*FUNCI�N AUTOGENERADO DE LA CLAVE-->EMPLEADO*/
...
/*CALL USP_REGISTRARPEDIDO(1,1,2,2);
CALL USP_REGISTRARDETALLEPEDIDO(1,1,5.99,1);
CALL USP_REGISTRARDETALLEPEDIDO(1,2,5.99,1);
CALL USP_REGISTRARBOLETA(1,'B01-0000001',11.98,null);
CALL USP_RESTARPRODUCTO(3,1);*/
