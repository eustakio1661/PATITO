            ...
            e
              ...
              .on(d.CLICK_DATA_API, function (e) {
                ...
                if ('true' !== n.attr('aria-disabled')) {
                  ...
                  t.hasClass(c)
                    ? (n.attr('aria-expanded', 'false'), a.removeActive(t))
                    : (n.attr('aria-expanded', 'true'),
                      a.setActive(t),
                      s.toggle &&
                        (a.removeActive(i), r.attr('aria-expanded', 'false'))),
        ...
        (e.show = function (e) {
          ...
          if (!this.transitioning && !o(e).hasClass(T)) {
            ...
            if ((t.trigger(i), !i.isDefaultPrevented())) {
              if (
                (t.parent(this.config.parentTrigger).addClass(c),
                this.config.toggle)
              ) {
                var r = t
